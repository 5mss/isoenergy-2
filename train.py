...
nnModel = sk_nn.MLPRegressor(activation='tanh', solver='adam', hidden_layer_sizes=(800, 800, 5500), random_state=1)
with h5py.File('train_feature_t.h5', 'r') as fin:
    X_test = fin['feature'][f'{part}'][...]
with h5py.File('train_target_4.h5', 'r') as tin:
